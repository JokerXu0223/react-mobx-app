...
import { getFooterBottom, getHeaderHeight, getHeaderPadding, xnBorderWidth } from '../utils/device';
    ...
    return (
      <View style={styles.xnLoading}>
        <View style={styles.xnLoadingHd}>
          ...
          >
            <Image style={styles.xnLoadingHdIcon} source={require('../assets/img/loadBack.png')} resizeMode="contain" />
          </TouchableOpacity>
        </View>
